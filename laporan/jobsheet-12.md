...
<p align="center">
  <img src="../praktikum/my-app-j12/public/img/logo_polinema.png" width="40%">
</p>
...
![1](../praktikum/my-app-j12/public/img/1.png)

### Langkah 2 - Struktur Dasar Middleware
![1](../praktikum/my-app-j12/public/img/2.png)

### Langkah 3 – Redirect Sederhana 
![1](../praktikum/my-app-j12/public/img/3.png)

### Langkah 4 – Batasi Route Tertentu 
![1](../praktikum/my-app-j12/public/img/4.png)

### Langkah 5 – Simulasi Sistem Login 
![1](../praktikum/my-app-j12/public/img/5.gif)
...
### Uji 2 – isLogin = true
![1](../praktikum/my-app-j12/public/img/6.gif)

### Uji 3 – Tambahkan Multiple Route 
![1](../praktikum/my-app-j12/public/img/7.gif)
...
- /products
![1](../praktikum/my-app-j12/public/img/8.png)
- /about
![1](../praktikum/my-app-j12/public/img/9.png)
- /login
![1](../praktikum/my-app-j12/public/img/10.png)

2. Implementasikan Middleware

- Redirect ke /login jika belum login.
- Izinkan akses jika login true.
![1](../praktikum/my-app-j12/public/img/11.png)
![1](../praktikum/my-app-j12/public/img/10.png)

3. Tambahkan proteksi hanya untuk route tertentu.
![1](../praktikum/my-app-j12/public/img/12.png)
