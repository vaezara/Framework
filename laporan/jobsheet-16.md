...
<p align="center">
  <img src="../praktikum/my-app-j16/public/img/logo_polinema.png" width="40%">
</p>
...
![1](../praktikum/my-app-j16/public/img/1.png)

### Langkah 2 – Buat Project Baru
![1](../praktikum/my-app-j16/public/img/2.png)

### Langkah 3 – Konfigurasi OAuth Consent Screen
![1](../praktikum/my-app-j16/public/img/3.png)

### Langkah 4 – Buat OAuth Credentials
![1](../praktikum/my-app-j16/public/img/4.png)

## C. Tambahkan Environment Variables 
![1](../praktikum/my-app-j16/public/img/5.png)

## D. Konfigurasi Google Provider di NextAuth dan Handle Callback JWT & Session
![1](../praktikum/my-app-j16/public/img/6.png)

## E. Tambahkan Button Login Google 
![1](../praktikum/my-app-j16/public/img/7.png)
![1](../praktikum/my-app-j16/public/img/8.png)

## G. Simpan Data Google ke Database 
![1](../praktikum/my-app-j16/public/img/9.png)
...
![1](../praktikum/my-app-j16/public/img/10.png)

- **User role member akses /admin** → Redirect  
![1](../praktikum/my-app-j16/public/img/11.png)

- **User role admin akses /admin** → Bisa masuk
![1](../praktikum/my-app-j16/public/img/12.png)
...
![1](../praktikum/my-app-j16/public/img/13.png)

2. Buat halaman khusus editor
![1](../praktikum/my-app-j16/public/img/14.png)

3. Tambahkan provider GitHub
![1](../praktikum/my-app-j16/public/img/15.png)
![1](../praktikum/my-app-j16/public/img/16.png)
![1](../praktikum/my-app-j16/public/img/17.png)

4. Refactor service agar reusable
![1](../praktikum/my-app-j16/public/img/18.png)
![1](../praktikum/my-app-j16/public/img/19.png)

5. Gunakan next/image untuk optimasi avatar
![1](../praktikum/my-app-j16/public/img/20.png)