...
<p align="center">
  <img src="../praktikum/my-app-j15/public/img/logo_polinema.png" width="40%">
</p>
...
![1](../praktikum/my-app-j15/public/img/1.png)

### Langkah 2 - Handle Login di Frontend
Tampilan login sudah sesuai dengan halaman registrasi
![1](../praktikum/my-app-j15/public/img/2.png)

### Langkah 3 – Authorize di NextAuth (Database Login)
![1](../praktikum/my-app-j15/public/img/3.png)

### Langkah 4 – Tambahkan Role ke Token
- Hasil login akun
![1](../praktikum/my-app-j15/public/img/4.png)
- Terdapat error
![1](../praktikum/my-app-j15/public/img/5.png)
- Hasil setelah perbaikan
![1](../praktikum/my-app-j15/public/img/6.png)

### Langkah 5 - Callback URL Logic
![1](../praktikum/my-app-j15/public/img/7.png)

### Langkah 6 – Membuat halaman Admin dan authoriz
- Hasil membuka halaman produk pada role user
![1](../praktikum/my-app-j15/public/img/8.png)
- Hasil membuka halaman admin pada role user (kembali ke home)
![1](../praktikum/my-app-j15/public/img/9.png)
- Mengubah role di firebase
![1](../praktikum/my-app-j15/public/img/10.png)
- Hasil membuka halaman admin dengan role admin
![1](../praktikum/my-app-j15/public/img/11.png)
...
• Tidak login
![1](../praktikum/my-app-j15/public/img/12.png)
...
![1](../praktikum/my-app-j15/public/img/13.png)

3. Buat halaman:
- /profile
![1](../praktikum/my-app-j15/public/img/14.png)

- /admin
![1](../praktikum/my-app-j15/public/img/11.png)

4. Proteksi /admin hanya untuk admin.
![1](../praktikum/my-app-j15/public/img/15.png)
