...
<p align="center">
  <img src="../praktikum/my-app-j10/public/img/logo_polinema.png" width="40%">
</p>
...
![1](../praktikum/my-app-j10/public/img/1.png)

### Langkah 2 - Implementasi CSR (Client Rendering) 

- Hasil cek API produk
![1](../praktikum/my-app-j10/public/img/2.png)

- Hasil Detail Produk ketika di klik
![1](../praktikum/my-app-j10/public/img/3.gif)

- Judul Detail Produk sudah ditengah
![1](../praktikum/my-app-j10/public/img/4.png)

### Langkah 3 - Implementasi SSR
![1](../praktikum/my-app-j10/public/img/5.gif)

### Langkah 4 - Implementasi Static Site Generation (Dynamic SSG) 
![1](../praktikum/my-app-j10/public/img/6.png)
![1](../praktikum/my-app-j10/public/img/7.png)

## Pengujian

### Uji 1 - CSR
Ada request API di network tab setelah detail produk di refresh
![1](../praktikum/my-app-j10/public/img/8.png)

### Uji 2 - SSR
Ketika detail produk di refresh tidak ada request API
![1](../praktikum/my-app-j10/public/img/9.png)

### Uji 3 - SSG

1. Hasil menjalankan `npm run build` dan `npm run start`
![1](../praktikum/my-app-j10/public/img/10.png)
![1](../praktikum/my-app-j10/public/img/11.png)

2. Menambahkan produk baru di database
![1](../praktikum/my-app-j10/public/img/12.png)

3. Halaman detail produk baru tidak muncul
![1](../praktikum/my-app-j10/public/img/13.png)

4. Hasil menjalankan ulang `npm run build` dan `npm run start`. Produk yang baru ditambahkan muncul
![1](../praktikum/my-app-j10/public/img/14.png)
![1](../praktikum/my-app-j10/public/img/15.png)
...
1. CSR
![1](../praktikum/my-app-j10/public/img/16.gif)

2. SSR
![1](../praktikum/my-app-j10/public/img/17.gif)

3. SSG
![1](../praktikum/my-app-j10/public/img/18.gif)
